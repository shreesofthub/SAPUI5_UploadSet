		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload Files using UploadSet UI Element",
									"targetURL": "#uploadsetr15-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uploadsetr15-display": {
								"semanticObject": "uploadsetr15",
								"action": "display",
								"description": "Upload Files using UploadSet UI Element",
								"title": "Upload Files using UploadSet UI Element",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadsetr15",
									"url": sap.ui.require.toUrl("uploadsetr15")
								}
							}
						}
					}
